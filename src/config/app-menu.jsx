const Menu = [
  ...
  { path: '/alertas-prime', icon: 'fa fa-circle-info', title: 'Indicadores',
    
  },
  { path: '/inconsistencias', icon: 'bi bi-exclamation-diamond-fill', title: 'Alertas',
    
  },
  { path: '/controle-prisoes', icon: 'bi bi-grid-3x3-gap-fill', title: 'Controle de Prisões',
    
  }, 
  { path: '/produtividade', icon: 'bi bi-bar-chart-line-fill', title: 'Produtividade',
    children: [
      { path: '/produtividade/produtividade-magistrado', title: 'Magistrados' },
      { path: '/produtividade/produtividade-serventia', title: 'Serventia' },
      { path: '/produtividade/produtividade-plantao', title: 'Plantão' }
    ]
  },
