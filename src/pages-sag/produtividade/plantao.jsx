...
export default function PlantaoProd(){
    ...
    return(
        <div>
            ...
            <li className="breadcrumb-item active">Produtividade - Plantão</li>
        </ol>
        <h1 className="page-header"><b>Produtividade das Serventias - Plantão</b></h1>
        ...
        <Panel theme="default" id="detalhesIndicadores">
            <PanelHeader noButton={true}>
                ...
                <Col>
					...
					<InputGroup className="mb-3">
							<DatePicker  className='form-control' showMonthYearPicker locale={ptBR} startDate={startDateSpg} endDate={endDateSpg} dateFormat="MM/yyyy" selected={startDateSpg}
              onChange={ handleChangeStartDataSpg }/>						
							<InputGroup.Text>Até</InputGroup.Text>							
							<DatePicker className='form-control' showMonthYearPicker locale={ptBR} dateFormat="MM/yyyy" startDate={startDateSpg} endDate={endDateSpg} selected={endDateSpg}
            ...
            <Row className='mb-4'>	
                <Col>
					<Form.Label for="serventia">Unidade</Form.Label>					
